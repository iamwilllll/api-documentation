...
export async function createEndpointController(req, res, next) {
    try {
        ...
        if (!method || !URL)
            throw new AppError('Method and URL are required', 400, 'INVALID_INPUT');
...
//# sourceMappingURL=createEndPoint.controller.js.map